...
class NewGroupPageProcess extends React.Component {
    constructor(props) {
        super(props);
    }

    componentDidMount() {
        this.props.navigation.setParams({NewGroupPageFinish: this._goNewGroupFinishScreen});
...
export default NewGroupPageProcess;
